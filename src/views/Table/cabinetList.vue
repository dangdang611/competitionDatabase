  ...
  <div class="table-container">
    ...
    >
      ...
      <el-table-column label="Pack" align="center">
        <el-table-column prop="pack" label="配置" width="100" align="center">
          <template #default="scope">
...
import Detail from '@/components/AllTable/detail.vue'
import CompareList from '@/components/AllTable/compare.vue'
import EditCell from '@/components/AllTable/editCell.vue'
